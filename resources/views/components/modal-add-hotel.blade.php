    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                <h3 id="title-modal" class="text-lg font-semibold text-gray-900 dark:text-white">
                    Add New Hotel
                </h3>
            ...
            <!-- Modal body -->
            <form id="form-create-hotel" action="{{ route('hotel.store') }}" method="POST"  class="p-4 md:p-5">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select id="kota" name="kota" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                            <option selected="">Select kota</option>
...
<script>
    const fromCreateHotel = document.getElementById('form-create-hotel');
    const closeModal = document.querySelector('[data-modal-toggle="crud-modal"]');

    closeModal.addEventListener('click', function() {
        fromCreateHotel.reset();
    });
</script>