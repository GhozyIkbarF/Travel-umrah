        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <button id="toggle-mini-sidebar" type="button"
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button"
                        ...
                        aria-controls="dropdown-example-product-plus"
                        data-collapse-toggle="dropdown-example-product-plus">
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Product Plus</span>
                    ...
                    <ul id="dropdown-example-product-plus" class="hidden py-2 space-y-2"></ul>
                </li>
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                        aria-controls="dropdown-example-product-regular"
                        data-collapse-toggle="dropdown-example-product-regular">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 18 21">
                            <path
                        ...
                        <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Product regular</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                stroke-width="2" d="m1 1 4 4 4-4" />
                    ...
                    <ul id="dropdown-example-product-regular" class="hidden py-2 space-y-2"
                        id='sidebar_list_product_regular'></ul>
                </li>
                <li>
                    <a href="{{ route('blog-news.index') }}"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Blog & news</span>
                    </a>
                </li>
                <li>
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        <li>
                            <a href="{{ route('paket.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Package</a>
                        </li>
                        <li>
                            <a href="{{ route('maskapai.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Maskapai</a>
                        </li>
                        <li>
                            <a href="{{ route('hotel.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Hotel</a>
                        </li>
                        <li>
                            <a href="{{ route('list-city-tour.index') }}"
                        ...
                        <li>
                            <a href="{{ route('free-promo.index') }}"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Free
                                & Promo</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Patner</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function() {
            ...
            axios.get('/package/list', {
                ...
                .then(function(response) {
                    function createLink(element) {
                        ...
                        a.setAttribute('href', `{{ route('product.index', '') }}/${encodedName}`);
                    ...
                    const sidebar_list_product_plus = document.getElementById(
                        'dropdown-example-product-plus');
                    response.data?.package_plus.forEach(element => {
                        sidebar_list_product_plus.appendChild(createLink(element));
                    });
                    const sidebar_list_product_regular = document.getElementById(
                        'dropdown-example-product-regular');
                    response.data?.package_regular.forEach(element => {
                        sidebar_list_product_regular.appendChild(createLink(element));
                    });
                })
        ...
        const toggleMiniSidebar = document.getElementById('toggle-mini-sidebar')
        const textsidebar = document.querySelectorAll("#logo-sidebar li span")
        toggleMiniSidebar.addEventListener('click', function() {
            textsidebar.forEach(element => {
        ...
        const deleteModalButton = document.querySelectorAll('.delete-button');
        deleteModalButton.forEach(function(button) {
            button.addEventListener('click', function() {

                var deleteLink = this.getAttribute('data-delete-link');
        ...
        const btnRemovePreviewImg = document.getElementById('btn-remove-img');
        ...
        inputImage.addEventListener('change', () => {
            ...
            if (file) {
                ...
                btnRemovePreviewImg.classList.remove('hidden');
                inputImage.classList.add('hidden');
                inputImage.removeAttribute('required');
            }
        })

        btnRemovePreviewImg.addEventListener('click', () => {
            imagePreview.setAttribute('src', '');
            imagePreview.setAttribute('alt', '');
            btnRemovePreviewImg.classList.add('hidden');
